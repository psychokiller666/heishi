		    ...
		    success: function(data){
		    	...
		    	function output(items){
		    		$.each(items, function(index, item){
			    		var str = '<li>\
							        <a href="/Portal/HsArticle/index/id/'+item.goods_id+'.html">\
						...
						if(item.goods_keywords[0]){
							str += '<a href="/HsCategories/tag_index/tag/'+item.goods_keywords[0]+'.html" class="classify">#'+item.goods_keywords[0]+'</a></div></div></li>';
						}else{
							str += '<a class="classify"></a></div></div></li>';
						}
